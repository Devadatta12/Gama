...
int main(int argc, char *argv[]){
    ...
    { // anonymous scope for managing handle scope
        ...
        global->Set(isolate, "getCollidedUUID",
                    v8::FunctionTemplate::New(isolate, gama::EventManager::GetCollidedUUID));
        global->Set(isolate, "getCollidedType",
                    v8::FunctionTemplate::New(isolate, gama::EventManager::GetCollidedType));
        global->Set(isolate, "getInputType",
                    v8::FunctionTemplate::New(isolate, gama::EventManager::GetInputType));
        ...
        sm->addScript("Input", "./GameProjects/"+game+"/Input.js", "object_context");
