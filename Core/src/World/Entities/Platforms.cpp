...
namespace gama{
    ...
    FixedPlatform::FixedPlatform(long uuid, int textureType, bool isLocal, Timeline* anchor, sf::Vector2f* position, sf::Vector2f* size):
        ...
        if (textureType == 1){
            texturePath = "./resources/moon.png";
        } else if(textureType == 2){
            texturePath =  "./resources/earth.png";
        } else{
            texturePath = "./resources/mars.png";
        }
    ...
    Entity *MovingPlatform::Construct(gama::Timeline *anchor, std::string &serialized) {
        ...
        Entity* platform = new MovingPlatform(uuid, isLocal, anchor, animationType,
                                             new sf::Vector2f(posX, posY),
                                             new sf::Vector2f(sizeX, sizeY));
        return platform;
    }
    ...
    MovingPlatform::MovingPlatform(long uuid, bool isLocal, Timeline* anchor, bool animationType, sf::Vector2f* position, sf::Vector2f* size):
